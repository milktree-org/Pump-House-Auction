...
// Content reproduced verbatim from pumphouseauctions.co.uk/privacy-policy/.
// NOTE: this is the stock WordPress privacy template and has never been
// tailored to the business — it describes blog comments, Gravatar and WordPress
// login cookies, and says nothing about valuation enquiries, bidder data, the
// CRM, or the analytics running on the site. It needs rewriting before launch;
// it is reproduced here unchanged rather than being altered by us.
const SECTIONS: LegalSection[] = [
  {
    id: 'who-we-are',
    title: 'Who we are',
    content: <p>Our website address is: http://pumphouseauctions.co.uk.</p>,
  },
  {
    id: 'comments',
    title: 'Comments',
  ...
  },
  {
    ...
    content: <p>If you request a password reset, your IP address will be included in the reset email.</p>,
  },
  {
    id: 'how-long-we-retain',
...
const PrivacyPolicyPage: React.FC = () => (
  <LegalPage
    ...
    standfirst="How Pump House Specialist Auctions collects, uses and stores your information."
    note="Reproduced from our published privacy policy."
    sections={SECTIONS}
    ctaHeading="Questions about your data?"
    ctaBody="If anything here is unclear, or you would like to know what information we hold, please get in touch and we will help."
  />
);
