    ...
    <div className="min-h-screen bg-pumphouse-bg selection:bg-pumphouse-navy selection:text-white pt-[85px]">
      ...
      <main>
        <Routes>
          ...
          <Route path="/about-us-page/" element={<OurStoryPage />} />
          <Route path="/buyers-faq/" element={<BuyPage />} />
          <Route path="/sell/" element={<SellPage />} />
          <Route path="/clearance/" element={<HouseClearancePage />} />
          <Route path="/probate/" element={<ProbatePage />} />
          <Route path="/gallery/" element={<GalleryPage />} />
          <Route path="/future-auctions-date/" element={<CalendarPage />} />
